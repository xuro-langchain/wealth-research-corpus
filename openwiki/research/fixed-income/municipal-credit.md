...
```mermaid
flowchart TD
    A["Taxable year begins on or after 2026-01-01"] --> B["Compare N.3 threshold with M.2 premise"]
    B --> C["Threshold premise invalidated"]
    B --> D["Record N.5 501(c)(3) treatment separately"]
    C --> E["Immediate review and re-issue trigger"]
    D --> E
    E --> F["Committee resolves binding allocation"]
```
