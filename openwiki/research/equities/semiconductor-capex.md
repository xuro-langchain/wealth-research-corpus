...
```mermaid
flowchart TD
    Date["Position date"] --> Window{"Which applicability window"}
    Window -->|"2025-07-01 to 2026-02-28"| Old["2025-06 overweight"]
    Window -->|"On or after 2026-03-01"| New["2026-02 neutral"]
    Old --> Record["Retain basis of record for later review"]
    New --> Current["Apply current research view to new position"]
```
