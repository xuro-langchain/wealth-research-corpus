...
This page records synthetic demonstration research, not investment advice. It separates two editions of the US semiconductor-capital-equipment view rather than applying the current conclusion retroactively. A position is reviewed against the edition in force when it was taken: the frozen 2025-06 note explicitly remains the basis of record for positions established while it stood, even when the review occurs later. [EQ-US-SEMI-CAPEX 2025-06, notice](repo://research/EQ/US/SEMI-CAPEX/2025-06.md#L3-L5) [edition applicability](repo://research/EQ/US/SEMI-CAPEX/2025-06.md#L19-L19)
